...
tailwind.config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        body: ["Nunito Sans", "Inter"],
        label: ["Nunito Sans", "Inter"],
        headline: ["Nunito Sans", "Inter"],
        display: ["Nunito Sans", "Inter"],
        "body-md": ["Nunito Sans", "Inter"],
        "body-lg": ["Nunito Sans", "Inter"],
        "body-sm": ["Nunito Sans", "Inter"],
        "label-md": ["Nunito Sans", "Inter"],
        "headline-lg": ["Nunito Sans", "Inter"],
        "headline-lg-mobile": ["Nunito Sans", "Inter"],
        "headline-md": ["Nunito Sans", "Inter"],
        "headline-sm": ["Nunito Sans", "Inter"],
      },
      fontSize: {
