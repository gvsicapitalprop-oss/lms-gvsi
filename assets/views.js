      ...
      render: async function (view) {
        ...
        function renderAiDraft(d) {
          ...
          inner.innerHTML =
            ...
            '<div class="bg-surface-container-low border border-outline-variant/40 rounded-xl p-md text-body-md text-on-surface whitespace-pre-wrap break-words">' + G.fmt(d.draft_body || '', true) + '</div>' + hand +
