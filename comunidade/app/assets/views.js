    ...
    render: function (view) {
      view.innerHTML =
        '<header class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-surface shadow-[0px_4px_20px_rgba(0,0,0,0.05)] h-14 flex items-center justify-between px-container-margin">' +
          '<span class="w-9"></span>' +
          '<div class="flex items-center"><img src="assets/logo-colorida.png" alt="GVSI" class="h-7 w-auto dark:hidden"><img src="assets/logo-branca.png" alt="GVSI" class="h-7 w-auto hidden dark:block"></div>' +
